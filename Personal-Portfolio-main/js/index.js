...
const translations = {
  ar: {
    ...
    hero_status: "متاح للشغل الحر",
    hero_greeting: "مرحباً، أنا 👋",
    hero_desc_1: "بحول أفكارك لـ",
    hero_desc_highlight: "تجارب رقمية مميزة",
    hero_desc_2: ". متخصص في بناء مواقع وتطبيقات ويب حديثة بأحدث التقنيات.",
    hero_explore: "استكشف أعمالي",
    contactMe: "تواصل معي",
    scroll_more: "اكتشف المزيد",
    about_subtitle: "من أنا",
    about_title_part1: "عن",
    my_name_full: "احمد الشيخ",
    about_heading_1: "بحب أحول الأفكار",
    about_heading_2: "لواقع رقمي",
    about_p1: "مطور واجهات أمامية بخبرة +8 سنوات في بناء تطبيقات ويب حديثة وتصميم تجارب مستخدم استثنائية.",
    about_p2: "بشتغل بأحدث التقنيات زي React و Next.js و TypeScript عشان أقدم حلول عالية الجودة وتعدي التوقعات.",
    about_edu: "نظم ومعلومات",
    about_projects_count: "+50 مشروع",
    about_clients_count: "+35 عميل سعيد",
    services_title: "ما أقدمه",
    service_1: "تطوير تطبيقات ويب متكاملة بـ React & Next.js",
    service_2: "تصميم واجهات مستخدم حديثة وجذابة",
    service_3: "تحسين الأداء وسرعة التحميل",
    service_4: "تطوير مواقع متوافقة مع جميع الأجهزة",
    skills_subtitle: "ما أتقنه",
    skills_title_1: "المهارات و",
    skills_title_2: "التقنيات",
    portfolio_subtitle: "أعمالي",
    portfolio_title_1: "معرض",
    portfolio_title_2: "المشاريع",
    filter_all: "الكل",
    filter_web: "مواقع الويب",
    filter_app: "التطبيقات",
    filter_design: "التصميم",
    filter_ecommerce: "التجارة الإلكترونية",
    start_project: "لنبدأ مشروعك القادم",
    testimonials_subtitle: "آراء العملاء",
    testimonials_title_1: "ماذا يقول",
    testimonials_title_2: "العملاء",
    contact_subtitle: "تواصل معي",
    contact_title_1: "يلا نبدأ",
    contact_title_2: "مشروعك",
    contact_desc: "عندك فكرة مشروع؟ تعالى نتكلم ونحولها لواقع",
    contact_email_title: "البريد الإلكتروني",
    contact_email_sub: "جاهز للرد خلال 24 ساعة",
    contact_phone_title: "رقم الهاتف",
    contact_phone_sub: "متاح من 9 صباحاً - 5 مساءً",
    contact_location_title: "الموقع",
    contact_location_val: "طنطا ، مصر",
    contact_location_sub: "متاح للعمل عن بعد",
    contact_social: "تابعني على",
    form_name: "الاسم الكامل",
    form_name_ph: "أدخل اسمك الكامل",
    form_email: "البريد الإلكتروني",
    form_phone: "رقم الهاتف",
    form_type: "نوع المشروع",
    form_type_ph: "اختر نوع المشروع",
    form_type_1: "موقع ويب",
    form_type_2: "تطبيق ويب",
    form_type_3: "تطبيق جوال",
    form_type_4: "تصميم UI/UX",
    form_type_5: "استشارة تقنية",
    form_budget: "الميزانية المتوقعة",
    form_budget_ph: "اختر الميزانية",
    form_budget_1: "أقل من 20,000 جنيه",
    form_budget_2: "20,000 - 50,000 جنيه",
    form_budget_3: "50,000 - 100,000 جنيه",
    form_budget_4: "أكثر من 100,000 جنيه",
    form_details: "تفاصيل المشروع",
    form_details_ph: "احكيلي تفاصيل مشروعك...",
    form_submit: "ابعت الرسالة",
    footer_desc: "أؤمن بأن البرمجة فن. هدفي مش بس كتابة كود، بل خلق تجربة مستخدم سلسة بتسيب أثر. بدمج التصميم الجمالي مع الأداء القوي عشان أقدم منتج نهائي متكامل.",
    footer_cv_sub: "تعرف على خبراتي",
    footer_cv_title: "حمل السيرة الذاتية (CV)",
    footer_working_on: "أعمل حالياً على:",
    footer_project: "مشروع SaaS لإدارة الفريق",
    footer_links: "روابط سريعة",
    footer_services: "الخدمات",
    service_1_short: "تطوير الويب",
    service_app_dev: "تطوير التطبيقات",
    service_uiux: "تصميم UI/UX",
    service_consulting: "الاستشارات التقنية",
    service_performance: "تحسين الأداء",
    service_support: "الصيانة والدعم",
    footer_copyright: "&copy; 2025 احمد الشيخ. جميع الحقوق محفوظة."
  },
  en: {
    nav_home: "Home",
    nav_about: "About",
    ...
    projects: [
      {
        ...
        description: "تطبيق تجارة إلكترونية لبيع المنتجات الصحية مع ميزات CRUD كاملة.",
      ...
      },
      {
        ...
        description: "موقع هبوط للسفر والسياحة مع تكامل لتجربة مستخدم ديناميكية.",
      ...
      },
      {
        ...
        description: "نظم مبسط لحجز الادوار المالية وإدارة الحسابات المصرفية.",
      ...
      },
      {
        ...
        description: "تطبيق تحديد مواقيت الصلاة بدقة بناءً على الموقع الجغرافي للمستخدم.",
      ...
      },
      {
        ...
        description: "حاسبة المعدل التراكمي الجامعي لتسهيل متابعة الأداء الأكاديمي للطلاب.",
        tools: ["HTML", "CSS", "JS", "Bootstrap"]
      },
      {
        id: "6",
        title: "موقع عرض نتيجه الطلاب",
        category: "landing",
        image: "Personal-Portfolio-main/imgs/HICS3.png",
        link: "https://el-sheikh-project.github.io/HICS3/",
        description: " موقع بسيط لعرض نتائج الطلاب بطريقة منظمة وسهلة الاستخدام.",
        tools: ["HTML", "CSS", "JS", "Bootstrap", "JSON"]
      },
      {
        id: "7",
        title: "موقع تعريفي شخصي",
        category: "landing",
        image: "Personal-Portfolio-main/imgs/Portfolio.png",
        link: "https://el-sheikh-project.github.io/Portfolio-Task-HTML-CSS/",
        description: "موقع تعريفي لشخصي لعرض المهارات والمشاريع والخبرات بطريقة احترافية.",
        tools: ["HTML", "CSS", "JS", "Bootstrap"]
      },
      {
        id: "8",
        ...
        description: "نظام CRUD باستخدام JavaScript لتسهيل الاستخدام والتعديل والحذف لبيانات JSON.",
        tools: ["HTML", "CSS", "JS", "Bootstrap"]
      },
      {
        id: "9",
...
function initInteractions() {
  ...
  // const textToType = "احمد الشيخ"; // Replaced by dynamic based on lang if needed, or static name
  // Actually, let's make it bilingual
  const texts = {
    ar: ["احمد الشيخ", "مطور واجهات أمامية", "مصمم ويب"],
